...
typedef struct _FPDF_FORMFILLINFO {
  ...
  *       None.
  * */
    FPDF_SYSTEMTIME (*FFI_GetLocalTime)
    (struct _FPDF_FORMFILLINFO* pThis);
  ...
  *       The handle to FPDF_FILEHANDLER.
  **/
    FPDF_LPFILEHANDLER (*FFI_DownloadFromURL)
    (struct _FPDF_FORMFILLINFO* pThis,
        FPDF_WIDESTRING URL);
    /**
